...
data_root = 'mmaction_running/video_train/'
data_root_val = 'mmaction_running/video_val/'
ann_file_train = 'mmaction_running/data_train.txt'
ann_file_val = 'mmaction_running/data_val.txt'
...
train_cfg = dict(
    ...
    max_epochs=100,  # change from 100 to 50
    val_begin=1,
    val_interval=1)
